...
dep_crossbar = git $(GT_FETCH_AS)2600hz/kazoo-crossbar.git $(BRANCH)
dep_doodle = git $(GT_FETCH_AS)2600hz/kazoo-doodle.git $(BRANCH)
dep_ecallmgr = git $(GT_FETCH_AS)2600hz/kazoo-ecallmgr.git $(BRANCH)
...
dep_jonny5 = git $(GT_FETCH_AS)2600hz/kazoo-jonny5.git $(BRANCH)
...
dep_stepswitch = git $(GT_FETCH_AS)2600hz/kazoo-stepswitch.git $(BRANCH)
...
dep_kazoo_ast = git $(GT_FETCH_AS)2600hz/kazoo-ast.git $(BRANCH)
