...
| Bridge with remote TLS broker | Native TLS/counted retry pass6035/ef7ad0; normal main-SH service deployment/restoration pass65096/3e586e; idle broker stop/start with same-process single-consumer recovery passes53408/858b7f. Separate native child with one loopback HTTP POST held in flight exits78 after AMQP loss and retains the body without a second POST (42712/afe573). Fresh-host remote topology/reboot, installed uncertain-exit restart policy, post-response settlement loss and HA recovery/deduplication remain open. |
