...
const expected = ['blackhole.html', 'supervision.html', 'coverage.json', 'index.html', 'openapi.json', 'planned.openapi.json', 'portal.css', 'portal.js', 'vendor/LICENSE', 'vendor/NOTICE', 'vendor/swagger-ui-bundle.js', 'vendor/swagger-ui.css'].sort();
