...
| BH-05 | ACTIVE — API + installer | Document native Blackhole handshake, discovery, JSON frames and Next.js lifecycle in OpenAPI extensions and /apis companion documentation; keep proposed dashboard contracts distinct. Verify native app/listener and reverse proxy, separate-node configuration, reconnect/failover and real authenticated event delivery before production acceptance. |
