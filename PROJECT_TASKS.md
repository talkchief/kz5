...
| SEC-01 | DEPLOYED — HTTPS/WSS PASS; renewal open | Matching protected private key supplied; normal UI installer90345/4232b3 deploys HTTPS and HTTP redirect. Actual browser72297/af0738 validates trusted HTTPS UI/API and WSS upgrade; user confirms login. Ten catalog entries migrated to HTTPS with exact receipts. Renewal lifecycle remains unverified; .44 private HTTP test is not a separate public-TLS deployment. |
