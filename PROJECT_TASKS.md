...
20 live API/call checks and seven deployed browser checks pass. UI and `/apis/`
...
| FWD-04 | DEPLOYED / BROWSER PASS | Account Settings language selector EN/HE/AR/ES/FR, current-behavior/reset state, scoped save and stale-form protection, localization, account-switch and restricted-user tests. Ship through tracked installer patches and the compiled bundle. |
